...
function GetServerConfig() {
    ...
    xhttp.onload = function () {
        ...
        document.getElementById("GarageVersion").innerText = obj["GarageVersion"];
        document.getElementById("StandbyTick").innerText = obj["StandbyTick"];
        document.getElementById("DynamicTick").checked = obj["DynamicTick"];
        document.getElementById("MessageMaxPayload").innerText = obj["MessageMaxPayload"];
        document.getElementById("DynamicTickMultiplier").innerText = obj["DynamicTickMultiplier"];
        document.getElementById("HubPostTimeout").innerText = obj["HubPostTimeout"];
        document.getElementById("MessageMTU").innerText = obj["MessageMTU"];
        document.getElementById("HubPostTimeout").innerText = obj["HubPostTimeout"];
    }
...
function ApplyConfigChanges() {
    ...
    var jsonconfig = {
        ...
        "GarageVersion": document.getElementById("GarageVersion").innerText,
        "StandbyTick": document.getElementById("StandbyTick").innerText,
        "DynamicTick": document.getElementById("DynamicTick").checked,
        "MessageMaxPayload": document.getElementById("MessageMaxPayload").innerText,
        "DynamicTickMultiplier": document.getElementById("DynamicTickMultiplier").innerText,
        "HubPostTimeout": document.getElementById("HubPostTimeout").innerText,
        "MessageMTU": document.getElementById("MessageMTU").innerText,
        "MessageMaxPayload": document.getElementById("MessageMaxPayload").innerText,
    }
...
function GetServerStats() {
    ...
    xhttp.onload = function () {
        ...
        document.getElementById("Fragments").innerText = obj["Fragments"];
