...
{
    public class RiderPhysics : FrostyModule
    {
		...
		public string ActiveDir = Application.dataPath + "/FrostyPGameManager/Presets/Physics/ActiveProfile/";
		...
		void Start()
        {
			...
			if (!File.Exists(ActiveDir + "Active.json"))
			{
				Save("Active");
				Load(new DirectoryInfo(ActiveDir + "Active.json").GetFiles()[0]);
			}
            else if(File.Exists(ActiveDir + "Active.json"))
            {
				Load(new DirectoryInfo(ActiveDir + "Active.json").GetFiles()[0]);
		...
		public override void Show()
        {
			...
			try
			{
				...
				{
					if(File.Exists(PresetDirectory + "Default.json"))
                    {
						Load(new DirectoryInfo(PresetDirectory).GetFiles("Default.json", SearchOption.TopDirectoryOnly)[0]);
                    }
				}
				GUILayout.Space(10);
				...
				if (loadpresetsbool)
				{
					...
					GUILayout.Space(30);
					GUILayout.Label("Saved Presets:", InGameUI.instance.Generalstyle);
					GUILayout.Space(10);
                ...
                else
                {
					...
					GUILayout.Space(5);
					GUILayout.BeginHorizontal();
					GUILayout.Label("Gravity = " + Physics.gravity.y, InGameUI.instance.MiniPanelStyle, GUILayout.MaxWidth(120));
					...
					GUILayout.BeginHorizontal();
					GUILayout.Label("Max Pedal Force : " + pedalingmanager.maxPedalVel.ToString(), InGameUI.instance.MiniPanelStyle, GUILayout.MaxWidth(120));
					...
					if (opennollies)
					{
						...
						GUILayout.Label("Standard Nollie Min Force" + groundedsettings.nollieMinForce.ToString(), InGameUI.instance.MiniPanelStyle);
						nollieMin = GUILayout.HorizontalSlider(nollieMin, 0.5f, 5);
						GUILayout.Label("Standard Nollie Max Force" + groundedsettings.nollieMaxForce.ToString(), InGameUI.instance.MiniPanelStyle);
						nollieMax = GUILayout.HorizontalSlider(nollieMax, 0.5f, 5);
						GUILayout.Space(30);
						GUILayout.Label("Nosey pop Max Force" + Noseysettings.nollieMaxForce.ToString(), InGameUI.instance.MiniPanelStyle);
						NoseyNollieMax = GUILayout.HorizontalSlider(NoseyNollieMax, 0.5f, 5);
						GUILayout.Label("Nosey pop Min Force" + Noseysettings.nollieMinForce.ToString(), InGameUI.instance.MiniPanelStyle);
						NoseyNollieMin = GUILayout.HorizontalSlider(NoseyNollieMin, 0.5f, 5);
						GUILayout.Space(30);
						GUILayout.Label("Smith Nollie Max Force" + Smithsettings.nollieMaxForce.ToString(), InGameUI.instance.MiniPanelStyle);
						SmithNollieMax = GUILayout.HorizontalSlider(SmithNollieMax, 0.5f, 5);
						GUILayout.Label("Smith Nollie Min Force" + Smithsettings.nollieMinForce.ToString(), InGameUI.instance.MiniPanelStyle);
						SmithNollieMin = GUILayout.HorizontalSlider(SmithNollieMin, 0.5f, 5);
						GUILayout.Space(30);
						GUILayout.Label("Feeble Nollie Max Force" + Feeblesettings.nollieMaxForce.ToString(), InGameUI.instance.MiniPanelStyle);
						FeebleNollieMax = GUILayout.HorizontalSlider(FeebleNollieMax, 0.5f, 5);
						GUILayout.Label("Feeble Nollie Min Force" + Feeblesettings.nollieMinForce.ToString(), InGameUI.instance.MiniPanelStyle);
						FeebleNollieMin = GUILayout.HorizontalSlider(FeebleNollieMin, 0.5f, 5);
						GUILayout.Space(30);
						GUILayout.Label("Tooth Nollie Max Force" + Toothsettings.nollieMaxForce.ToString(), InGameUI.instance.MiniPanelStyle);
						ToothNollieMax = GUILayout.HorizontalSlider(ToothNollieMax, 0.5f, 5);
						GUILayout.Label("Tooth Nollie Min Force" + Toothsettings.nollieMinForce.ToString(), InGameUI.instance.MiniPanelStyle);
						ToothNollieMin = GUILayout.HorizontalSlider(ToothNollieMin, 0.5f, 5);
						GUILayout.Space(30);
						GUILayout.Label("Crank Nollie Max Force" + Cranksettings.nollieMaxForce.ToString(), InGameUI.instance.MiniPanelStyle);
						CrankNollieMax = GUILayout.HorizontalSlider(CrankNollieMax, 0.5f, 5);
						GUILayout.Label("Crank Nollie Min Force" + Cranksettings.nollieMinForce.ToString(), InGameUI.instance.MiniPanelStyle);
						CrankNollieMin = GUILayout.HorizontalSlider(CrankNollieMin, 0.5f, 5);
						GUILayout.Space(30);
						GUILayout.Label("Crook Nollie Max Force" + Crooksettings.nollieMaxForce.ToString(), InGameUI.instance.MiniPanelStyle);
						CrookNollieMax = GUILayout.HorizontalSlider(CrookNollieMax, 0.5f, 5);
						GUILayout.Label("Crook Nollie Min Force" + Crooksettings.nollieMinForce.ToString(), InGameUI.instance.MiniPanelStyle);
						CrookNollieMin = GUILayout.HorizontalSlider(CrookNollieMin, 0.5f, 5);
						GUILayout.Space(30);
						GUILayout.Label("LipTrick Nollie Max Force" + LipTrickhopsettings.nollieMaxForce.ToString(), InGameUI.instance.MiniPanelStyle);
						LipTrickNollieMax = GUILayout.HorizontalSlider(LipTrickNollieMax, 0.5f, 5);
						GUILayout.Label("LipTrick Nollie Min Force" + LipTrickhopsettings.nollieMinForce.ToString(), InGameUI.instance.MiniPanelStyle);
						LipTrickNollieMin = GUILayout.HorizontalSlider(LipTrickNollieMin, 0.5f, 5);
						GUILayout.Space(30);
						GUILayout.Label("Luce-E/Un-Luc-E Nollie Max Force" + lucesettings.nollieMaxForce.ToString(), InGameUI.instance.MiniPanelStyle);
						LuceNollieMax = GUILayout.HorizontalSlider(LuceNollieMax, 0.5f, 5);
						GUILayout.Label("Luce-E/Un-Luc-E Nollie Min Force" + lucesettings.nollieMinForce.ToString(), InGameUI.instance.MiniPanelStyle);
						LuceNollieMin = GUILayout.HorizontalSlider(LuceNollieMin, 0.5f, 5);
						GUILayout.Space(30);
						GUILayout.Label("Pegs Nollie Max Force" + doublepegssettings.nollieMaxForce.ToString(), InGameUI.instance.MiniPanelStyle);
						PegsNollieMax = GUILayout.HorizontalSlider(PegsNollieMax, 0.5f, 5);
						GUILayout.Label("Pegs Nollie Min Force" + doublepegssettings.nollieMinForce.ToString(), InGameUI.instance.MiniPanelStyle);
						PegsNollieMin = GUILayout.HorizontalSlider(PegsNollieMin, 0.5f, 5);
						GUILayout.Space(30);
						GUILayout.Label("Pedal Feebs Nollie Max Force" + Pedalfeeblesettings.nollieMaxForce.ToString(), InGameUI.instance.MiniPanelStyle);
						PedalFeebsNollieMax = GUILayout.HorizontalSlider(PedalFeebsNollieMax, 0.5f, 5);
						GUILayout.Label("Pedal Feebs Nollie Min Force" + Pedalfeeblesettings.nollieMinForce.ToString(), InGameUI.instance.MiniPanelStyle);
					...
					if (openhops)
					{
						...
						GUILayout.Label("Hop Min Force" + groundedsettings.jHopMinForce.ToString(), InGameUI.instance.MiniPanelStyle);
						hopMin = GUILayout.HorizontalSlider(hopMin, 0.5f, 10);
						GUILayout.Label("Hop Max Force" + groundedsettings.jHopMaxForce.ToString(), InGameUI.instance.MiniPanelStyle);
						hopMax = GUILayout.HorizontalSlider(hopMax, 0.5f, 10);

						GUILayout.Space(30);


						GUILayout.Label("Smith Hop Max Force" + Smithsettings.jHopMaxForce.ToString(), InGameUI.instance.MiniPanelStyle);
						SmithhopMax = GUILayout.HorizontalSlider(SmithhopMax, 0.5f, 10);
						GUILayout.Label("Smith Hop Min Force" + Smithsettings.jHopMinForce.ToString(), InGameUI.instance.MiniPanelStyle);
						SmithhopMin = GUILayout.HorizontalSlider(SmithhopMin, 0.5f, 10);
						GUILayout.Space(30);
						GUILayout.Label("Feeble Hop Max Force" + Feeblesettings.jHopMaxForce.ToString(), InGameUI.instance.MiniPanelStyle);
						FeeblehopMax = GUILayout.HorizontalSlider(FeeblehopMax, 0.5f, 10);
						GUILayout.Label("Feeble Hop Min Force" + Feeblesettings.jHopMinForce.ToString(), InGameUI.instance.MiniPanelStyle);
						FeeblehopMin = GUILayout.HorizontalSlider(FeeblehopMin, 0.5f, 10);
						GUILayout.Space(30);
						GUILayout.Label("Ice Hop Max Force" + Icesettings.jHopMaxForce.ToString(), InGameUI.instance.MiniPanelStyle);
						IcehopMax = GUILayout.HorizontalSlider(IcehopMax, 0.5f, 10);
						GUILayout.Label("Ice Hop Min Force" + Icesettings.jHopMinForce.ToString(), InGameUI.instance.MiniPanelStyle);
						IcehopMin = GUILayout.HorizontalSlider(IcehopMin, 0.5f, 10);

						GUILayout.Space(30);
						GUILayout.Label("Crank Hop Max Force" + Cranksettings.jHopMaxForce.ToString(), InGameUI.instance.MiniPanelStyle);
						CrankhopMax = GUILayout.HorizontalSlider(CrankhopMax, 0.5f, 10);
						GUILayout.Label("Crank Hop Min Force" + Cranksettings.jHopMinForce.ToString(), InGameUI.instance.MiniPanelStyle);
						CrankhopMin = GUILayout.HorizontalSlider(CrankhopMin, 0.5f, 10);
						GUILayout.Space(30);
						GUILayout.Label("Crook Hop Max Force" + Crooksettings.jHopMaxForce.ToString(), InGameUI.instance.MiniPanelStyle);
						CrookhopMax = GUILayout.HorizontalSlider(CrookhopMax, 0.5f, 10);
						GUILayout.Label("Crook Hop Min Force" + Crooksettings.jHopMinForce.ToString(), InGameUI.instance.MiniPanelStyle);
						CrookhopMin = GUILayout.HorizontalSlider(CrookhopMin, 0.5f, 10);
						GUILayout.Space(30);
						GUILayout.Label("LipTrick Hop Max Force" + LipTrickhopsettings.jHopMaxForce.ToString(), InGameUI.instance.MiniPanelStyle);
						LipTrickhopMax = GUILayout.HorizontalSlider(LipTrickhopMax, 0.5f, 10);
						GUILayout.Label("LipTrick Hop Min Force" + LipTrickhopsettings.jHopMinForce.ToString(), InGameUI.instance.MiniPanelStyle);
						LipTrickhopMin = GUILayout.HorizontalSlider(LipTrickhopMin, 0.5f, 10);
						GUILayout.Space(30);
						GUILayout.Label("Luce-E/Un Luce-E Hop Max Force" + lucesettings.jHopMaxForce.ToString(), InGameUI.instance.MiniPanelStyle);
						LucehopMax = GUILayout.HorizontalSlider(LucehopMax, 0.5f, 10);
						GUILayout.Label("Luce-E/Un Luce-E Hop Min Force" + lucesettings.jHopMinForce.ToString(), InGameUI.instance.MiniPanelStyle);
						LucehopMin = GUILayout.HorizontalSlider(LucehopMin, 0.5f, 10);
						GUILayout.Space(30);
						GUILayout.Label("Pegs Hop Max Force" + doublepegssettings.jHopMaxForce.ToString(), InGameUI.instance.MiniPanelStyle);
						PegshopMax = GUILayout.HorizontalSlider(PegshopMax, 0.5f, 10);
						GUILayout.Label("Pegs Hop Min Force" + doublepegssettings.jHopMinForce.ToString(), InGameUI.instance.MiniPanelStyle);
						PegshopMin = GUILayout.HorizontalSlider(PegshopMin, 0.5f, 10);
						GUILayout.Space(30);
						GUILayout.Label("Manny Hop Max Force" + Mannyhopsettings.jHopMaxForce.ToString(), InGameUI.instance.MiniPanelStyle);
						MannyhopMax = GUILayout.HorizontalSlider(MannyhopMax, 0.5f, 10);
						GUILayout.Label("Manny Hop Min Force" + Mannyhopsettings.jHopMinForce.ToString(), InGameUI.instance.MiniPanelStyle);
						MannyhopMin = GUILayout.HorizontalSlider(MannyhopMin, 0.5f, 10);
						GUILayout.Space(30);
						GUILayout.Label("Pedal Feebs Hop Max Force" + Pedalfeeblesettings.jHopMaxForce.ToString(), InGameUI.instance.MiniPanelStyle);
						PedalFeebshopMax = GUILayout.HorizontalSlider(PedalFeebshopMax, 0.5f, 10);
						GUILayout.Label("Pedal Feebs Hop Min Force" + Pedalfeeblesettings.jHopMinForce.ToString(), InGameUI.instance.MiniPanelStyle);
