...
namespace FrostyP_Game_Manager
{
    public class Teleport : MonoBehaviour
    {
        ...
        public void Show()
        {
            ...
            GUILayout.Label("LB/RB Rotate : A to Place : Pad shortcut (Xbox) - LT + RT + RS hold then LS click",labels);
        ...
        GameObject GetBmx()
        {
            GameObject Bmx_Root = Instantiate(PIPE_Multiplayer.LocalPlayer.instance.Bmx_Root);
